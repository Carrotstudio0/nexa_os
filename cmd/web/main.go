...
func main() {
	...
	fmt.Printf("\n")
	fmt.Printf("╔════════════════════════════════════════════════════════════╗\n")
	fmt.Printf("║        🌐 Nexa Storage Server - متقدم و احترافي            ║\n")
	fmt.Printf("╚════════════════════════════════════════════════════════════╝\n\n")
	fmt.Printf("📡 اتصل من جهازك: http://%s:%s\n", localIP, Port)
	fmt.Printf("💻 من جهازك المحلي: http://localhost:%s\n", Port)
	fmt.Printf("📂 مجلد التخزين: %s\n\n", StorageRoot)
	fmt.Printf("✅ الخادم جاهز لاستقبال الملفات...\n")
	fmt.Printf("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n")
